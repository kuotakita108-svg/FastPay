...
export default function MarketingAccountForm({onClose}){
  ...
  return <section className="agent-account-form marketing-account-form">
    ...
    {created&&<div className="agent-account-success"><CheckCircle2/><div><strong>Marketing baru berhasil ditambahkan</strong><small className="created-account-meta"><span>ID Marketing</span><b>{created.id}</b><span>Username</span><b>{created.username}</b></small><small>Akun dapat langsung dipakai login. Panel Marketing dimulai kosong sampai Marketing tersebut mendaftarkan agent sendiri.</small></div></div>}
