...
const promos = [
  ...
  { tag: 'ISI SALDO', title: 'Bonus KitaPoint 2×', text: 'Top up saldo minimal Rp100.000 hari ini.', action: 'Isi Saldo', icon: WalletCards, tone: 'emerald', image: promoWallet, position: '78%', to: '/app/balance/topup' },
