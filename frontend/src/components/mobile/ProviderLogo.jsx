...
function ProviderSvgLogo({spec}){
  if(spec.type==='simple')return <svg className="provider-svg-logo provider-svg-simple" viewBox="0 0 24 24" aria-hidden="true"><path fill={spec.color||'#111827'} d={spec.icon.path}/></svg>
  if(spec.type==='pointblank')return <svg className="provider-svg-logo provider-svg-game" viewBox="0 0 80 80" aria-hidden="true"><defs><linearGradient id="pbLogo" x1="16" y1="12" x2="64" y2="68"><stop stopColor="#f43f5e"/><stop offset="1" stopColor="#111827"/></linearGradient></defs><rect x="10" y="10" width="60" height="60" rx="17" fill="url(#pbLogo)"/><path d="M23 47l13-25h15c9 0 15 6 15 14s-6 14-15 14h-8l-5 10H25l5-10z" fill="#fff"/><circle cx="50" cy="36" r="7" fill="#ef4444"/></svg>
  if(spec.type==='aov')return <svg className="provider-svg-logo provider-svg-game" viewBox="0 0 80 80" aria-hidden="true"><defs><linearGradient id="aovLogo" x1="13" y1="10" x2="67" y2="70"><stop stopColor="#1d4ed8"/><stop offset=".55" stopColor="#7c3aed"/><stop offset="1" stopColor="#f59e0b"/></linearGradient></defs><rect x="10" y="10" width="60" height="60" rx="18" fill="url(#aovLogo)"/><path d="M40 17l21 11v18c0 11-8 18-21 23-13-5-21-12-21-23V28z" fill="#ffffff22" stroke="#fff" strokeWidth="4"/><path d="M28 53l12-27 12 27h-8l-2-6h-5l-2 6z" fill="#fff"/></svg>
