...
function ProviderSvgLogo({spec}){
  if(spec.type==='freefire')return <svg className="provider-svg-logo provider-svg-freefire provider-svg-game-banner" viewBox="0 0 360 120" aria-hidden="true"><defs><filter id="ffDust" x="-8%" y="-12%" width="116%" height="124%"><feTurbulence baseFrequency=".75" numOctaves="2" seed="8" type="fractalNoise"/><feColorMatrix type="saturate" values="0"/><feComponentTransfer><feFuncA type="table" tableValues="0 .12"/></feComponentTransfer></filter><linearGradient id="ffBlade" x1="0" x2="0" y1="0" y2="1"><stop stopColor="#ffd56f"/><stop offset=".45" stopColor="#f5a400"/><stop offset="1" stopColor="#f36a00"/></linearGradient></defs><rect width="360" height="120" rx="6" fill="#030303"/><g fontFamily="Impact, Haettenschweiler, 'Arial Black', sans-serif" fontSize="46" fontWeight="900" letterSpacing="1"><text x="28" y="74" fill="#f8fafc">FREE F</text><text x="232" y="74" fill="#f8fafc">RE</text><text x="28" y="74" fill="#f8fafc" filter="url(#ffDust)" opacity=".42">FREE F</text><text x="232" y="74" fill="#f8fafc" filter="url(#ffDust)" opacity=".42">RE</text></g><path d="M211 22c9 8 8 20 2 32l-9 22 15-8-4 25-21-1 7-30c-9 2-16 5-23 10 8-19 18-35 33-50z" fill="url(#ffBlade)"/><path d="M209 31c4 8 1 15-3 23l-4 11 8-5-2 13-9 1 4-18c-5 2-9 4-13 7 5-12 11-22 19-32z" fill="#fff1a3" opacity=".35"/><path d="M24 91h312" stroke="#ffffff12" strokeWidth="2"/></svg>
