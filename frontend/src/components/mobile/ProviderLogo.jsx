...
const automaticAliases={
  ...
  'Bank INA Perdana':'ina-perdana','INA Perdana':'ina-perdana',
  ...
  'Bank Kaltimtara':'kaltim',Kaltimtara:'kaltim','Bank Lampung':'lampung',Lampung:'lampung',
  'Bank Mandiri Taspen':'mandiri-taspen','Mandiri Taspen':'mandiri-taspen',
  'Bank Maspion':'maspion',Maspion:'maspion',Maybank:'maybank','Maybank Indonesia':'maybank',
  ...
  'Nobu Bank':'nobu','Bank Nobu':'nobu',Nobu:'nobu','Bank NTB Syariah':'ntb','NTB Syariah':'ntb',
  ...
  'QNB Indonesia':'qnb','Bank QNB Indonesia':'qnb',QNB:'qnb','Bank Raya':'raya',Raya:'raya',
  ...
  'Bank SulutGo':'sulut',SulutGo:'sulut','Bank Sumsel Babel':'sumsel-babel','Sumsel Babel':'sumsel-babel',
...
export default function ProviderLogo({name,className=''}){
  ...
  if(automatic)return <i className={`${className} provider-logo-rendered provider-logo-image`} data-brand={slug(clean)}><img src={automatic} alt={`Logo ${name}`} loading="lazy" decoding="async"/></i>
