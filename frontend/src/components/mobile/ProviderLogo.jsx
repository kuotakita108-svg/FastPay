...
function ProviderSvgLogo({spec}){
  if(spec.type==='freefire')return <svg className="provider-svg-logo provider-svg-freefire provider-svg-game-banner" viewBox="0 0 360 92" aria-hidden="true"><defs><filter id="ffRough" x="-6%" y="-12%" width="112%" height="124%"><feTurbulence baseFrequency=".95" numOctaves="2" seed="11" type="fractalNoise"/><feColorMatrix type="saturate" values="0"/><feComponentTransfer><feFuncA type="table" tableValues="0 .16"/></feComponentTransfer></filter><linearGradient id="ffKnife" x1="0" x2="0" y1="0" y2="1"><stop stopColor="#ffe28a"/><stop offset=".42" stopColor="#ffae12"/><stop offset="1" stopColor="#f26b00"/></linearGradient></defs><rect width="360" height="92" rx="4" fill="#020202"/><g fontFamily="Impact, Haettenschweiler, 'Arial Black', sans-serif" fontSize="56" fontWeight="900" letterSpacing="1.5"><text x="23" y="61" fill="#f8fafc">FREE F</text><text x="235" y="61" fill="#f8fafc">RE</text><text x="23" y="61" fill="#f8fafc" filter="url(#ffRough)" opacity=".5">FREE F</text><text x="235" y="61" fill="#f8fafc" filter="url(#ffRough)" opacity=".5">RE</text></g><path d="M214 10c9 8 9 21 2 34l-8 19 15-8-4 25-24-1 8-29c-9 2-18 5-25 10 9-21 20-38 36-50z" fill="url(#ffKnife)"/><path d="M211 20c4 7 2 14-2 22l-4 10 8-4-2 11-9 1 4-16c-5 2-9 4-13 7 5-12 11-22 18-31z" fill="#fff0b3" opacity=".35"/></svg>
