...
function ProviderSvgLogo({spec}){
  if(spec.type==='freefire')return <svg className="provider-svg-logo provider-svg-freefire provider-svg-game-banner" viewBox="0 0 300 110" aria-hidden="true"><defs><filter id="ffDust" x="-10%" y="-10%" width="120%" height="120%"><feTurbulence baseFrequency=".9" numOctaves="2" seed="8" type="fractalNoise"/><feColorMatrix type="saturate" values="0"/><feComponentTransfer><feFuncA type="table" tableValues="0 .18"/></feComponentTransfer></filter><linearGradient id="ffBlade" x1="0" x2="0" y1="0" y2="1"><stop stopColor="#ffd46b"/><stop offset=".45" stopColor="#f5a400"/><stop offset="1" stopColor="#f36a00"/></linearGradient></defs><rect width="300" height="110" rx="5" fill="#030303"/><g fontFamily="Impact, Haettenschweiler, 'Arial Black', sans-serif" fontSize="56" fontWeight="900" letterSpacing="1.5"><text x="18" y="70" fill="#f8fafc">FREE F</text><text x="184" y="70" fill="#f8fafc">RE</text><text x="18" y="70" fill="#f8fafc" filter="url(#ffDust)" opacity=".55">FREE F</text><text x="184" y="70" fill="#f8fafc" filter="url(#ffDust)" opacity=".55">RE</text></g><path d="M169 19c10 8 8 22 2 34l-10 22 18-10-5 28-23-1 8-31c-10 2-17 5-24 10 8-19 19-35 34-52z" fill="url(#ffBlade)"/><path d="M168 27c4 9 1 17-4 26l-5 11 10-5-3 14-11 1 5-20c-6 2-10 4-14 7 5-12 12-24 22-34z" fill="#fff1a3" opacity=".38"/><path d="M16 82h268" stroke="#ffffff12" strokeWidth="2"/></svg>
