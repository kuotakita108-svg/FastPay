...
function ProviderSvgLogo({spec}){
  ...
  if(spec.type==='aov')return <svg className="provider-svg-logo provider-svg-game" viewBox="0 0 120 64" aria-hidden="true"><defs><linearGradient id="aovLogo" x1="6" y1="5" x2="114" y2="59"><stop stopColor="#0f172a"/><stop offset=".45" stopColor="#1d4ed8"/><stop offset="1" stopColor="#f59e0b"/></linearGradient></defs><rect width="120" height="64" rx="8" fill="url(#aovLogo)"/><path d="M60 8l35 17v14c0 13-13 22-35 30-22-8-35-17-35-30V25z" fill="#ffffff18" stroke="#fff" strokeWidth="3"/><path d="M43 48l17-30 17 30H65l-5-10-5 10z" fill="#fff"/></svg>
