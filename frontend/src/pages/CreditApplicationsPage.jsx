    ...
    <section className={`panel credit-review-panel ${isStandaloneDetail ? 'detail-mode' : ''} ${(isMarketing || isAdmin) ? 'marketing-review' : ''} ${isOperator ? 'analyst-review operator-review' : ''}`}>
      ...
      {(isMarketing || isOperator || isAdmin) && view === 'peminjam' && <section className="borrower-directory-panel mentoring-directory">
        ...
        <div className="directory-agent-list">
          {!!directoryGroups.length && <div className="mentored-agent-columns"><span>Agent & aktivitas</span><span>Kelengkapan</span><span>Status</span><span>Kredit</span><span>Aksi cepat</span></div>}
