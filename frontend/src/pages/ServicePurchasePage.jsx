...
import {ArrowLeft,ShieldCheck,CheckCircle2,ChevronRight,WalletCards,Zap,LockKeyhole,Clock3} from 'lucide-react'
...
export default function ServicePurchasePage(){
 ...
 return <main className={`mobile-app modern-purchase service-${type}`}>
  ...
  <section className="modern-purchase-body">
   ...
   <section className="purchase-flow"><span className="active"><b>1</b>Isi Data</span><i/><span><b>2</b>Pilih Produk</span><i/><span><b>3</b>Bayar</span></section>
