...
export const serviceConfig={
  ...
  tv:config('TV Berlangganan','Internet & TV','Nomor Pelanggan','Masukkan nomor pelanggan TV',['MNC Vision','K-Vision','Transvision','Nex Parabola']),
  ...
  health:config('Klinik & Kesehatan','Kesehatan','Nomor Pasien','Masukkan nomor pasien',['Halodoc','Alodokter','Prodia','Kimia Farma']),
  ...
  tax:config('Pajak & Penerimaan Negara','Pajak Negara','Kode Billing','Masukkan kode billing',['DJP Online','Pajak Daerah','SIGNAL Samsat','Penerimaan Negara']),
...
// Hanya layanan yang memiliki SKU aktif pada katalog H2HR Pulsa24Jam.
// Fitur internal KuotaKita (misalnya kredit agent) tetap tersedia dari menu
// khususnya dan tidak dicampur sebagai produk provider.
export const allServices=[['Pulsa','pulsa',null,'Komunikasi'],['Paket Data','data',null,'Komunikasi'],['HP Pascabayar','pascabayar',null,'Komunikasi'],['E-Wallet','ewallet',null,'Keuangan'],['Transfer Bank','bank',null,'Keuangan'],['Uang Elektronik','emoney',null,'Keuangan'],['Asuransi','insurance',null,'Keuangan'],['BPJS','bpjs',null,'Tagihan'],['Token PLN','pln',null,'Rumah Tangga'],['PDAM','pdam',null,'Rumah Tangga'],['Gas PGN','gas',null,'Rumah Tangga'],['Internet & WiFi','telkom',null,'Rumah Tangga'],['TV Kabel','tv',null,'Hiburan'],['Voucher Game','game',null,'Hiburan'],['Voucher Digital','voucher',null,'Hiburan'],['Streaming & Musik','streaming',null,'Hiburan'],['Cicilan Multifinance','multifinance',null,'Cicilan'],['Pajak & Negara','tax',null,'Pajak']]
