...
func (s *AuthService) Login(username, password string) (domain.AuthResult, error) {
	...
	accounts := map[string]domain.User{"octa11": {ID: "USR-001", Username: "octa", Name: "Octa User", Role: "user", Balance: 275000, Phone: "081234567890", Email: "octa@gmail.com"}, "octa22": {ID: "MST-001", Username: "octa", Name: "Octa Master", Role: "master", Balance: 25000000, Phone: "081234567890", Email: "master@fastpay.id"}, "octa33": {ID: "ADM-001", Username: "octa", Name: "Octa Admin", Role: "admin", Balance: 8500000, Phone: "081234567890", Email: "admin@fastpay.id"}}
